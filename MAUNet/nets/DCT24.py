...
class Block_ViT(nn.Module):
    def __init__(self, config, vis, channel_num):
        ...
        self.attn_norm =  LayerNorm(config.KV_size1,eps=1e-6)
...
class DCT24(nn.Module):
    def __init__(self, config, vis, img_size, channel_num=[128, 512], patchSize=[16, 4]):
        super().__init__()
